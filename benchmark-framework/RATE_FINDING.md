...
history-dependent verdict into a function of rate — see the trial finding below, where the same 800k
candidate returned opposite verdicts on the same broker minutes apart.
